...
@media (prefers-color-scheme: dark) {
    ...
    #modal-content input[type="radio"]:checked ~ label[for|="task-priority"],
    .task-lbl-h,
    .task-lbl-l,
    .task-lbl-m {
        color: var(--fglight);
