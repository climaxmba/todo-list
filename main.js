...
const projectsHandler = (function () {
  ...
  function initDefaults(reset) {
    ...
    addProject(
      new _modules_projectsTasks_js__WEBPACK_IMPORTED_MODULE_1__.Project(_modules_projectsTasks_js__WEBPACK_IMPORTED_MODULE_1__.Project.default.title, _modules_projectsTasks_js__WEBPACK_IMPORTED_MODULE_1__.Project.default.task)
    );
    addNote(new _modules_projectsTasks_js__WEBPACK_IMPORTED_MODULE_1__.Note(_modules_projectsTasks_js__WEBPACK_IMPORTED_MODULE_1__.Note.default.title, _modules_projectsTasks_js__WEBPACK_IMPORTED_MODULE_1__.Note.default.note));
    addCheckList(
      new _modules_projectsTasks_js__WEBPACK_IMPORTED_MODULE_1__.CheckList(
        _modules_projectsTasks_js__WEBPACK_IMPORTED_MODULE_1__.CheckList.default.listTxt
      )
    );
